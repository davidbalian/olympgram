        ...
        {isLoading ? (
          ...
          <>
            <div className="post">
              ...
              <p style={{ textAlign: "center" }}>
                Είσαι από την Κύπρο Ρωμαίικης εποχής, και επειδή είσαι
                κοινωνικός, έχεις πολλούς φίλους στα social media. Κάνε scroll
                και μάθε περισσότερα για τη ζωή των ανθρώπων τότε.
              </p>
            </div>
            {posts
